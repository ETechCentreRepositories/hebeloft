        ...
        <table class="table table-striped" id="createSalesOrderTable">
            ...
            <?php if(Session::has('cartSalesOrder')): ?>
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td><?php echo e($product['subtotal']); ?></td></tr>
            ...
            <?php if(Session::has('cartSalesOrder')): ?>
                ...
                <td></td>
                <td>Sub total</td>
                <td><?php echo e(Session::has('cartSalesOrder') ? Session::get('cartSalesOrder')-> subTotal : ''); ?></td></tr>
                <!-- <tr><td></td>
                <td></td>
                <td></td>
                <td>Total discount</td>
                <td><input name="quantity" type="number" id="quantity" type="text" style="width:60px;" value="<?php echo e(Session::has('cartSalesOrder') ? Session::get('cartSalesOrder')-> discount : ''); ?>"/></td></tr>
                <tr><td></td>
                <td></td>
                <td></td>
                <td>Final Price</td>
                <td><?php echo e(Session::has('cartSalesOrder') ? Session::get('cartSalesOrder')-> totalPrice : ''); ?></td></tr> -->
            <?php endif; ?>
            </tbody>
        </table>
        <div class="row">
