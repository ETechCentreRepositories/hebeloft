...
<div class="topMargin container">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
        <a href="{{ route('exportInventory_brand.file',['type'=>'csv']) }}"><button type="button" class="btn btn-warning" style="width: 100%;">By Brand</button></a>
        </div>
        <div class="col-md-2">
        <a href="{{ route('exportInventory_category.file',['type'=>'csv']) }}"><button type="button" class="btn btn-warning" style="width: 100%;">By Category</button></a>
        </div>
        <div class="col-md-2">
        <a href="{{ route('exportInventory_outlet.file',['type'=>'csv']) }}"><button type="button" class="btn btn-warning" style="width: 100%;">By Outlets</button></a>
        </div>
    </div>
    @endif
